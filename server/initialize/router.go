...
func Routers() *gin.Engine {
...

	{
		...
		deviceRouter.InitDeviceCategoryRouter(PrivateGroup)                  // 设备类别路由
		deviceRouter.InitDeviceModelRouter(PrivateGroup)                     // 设备型号路由
		deviceRouter.InitFirmwareVersionRouter(PrivateGroup, PublicGroup)    // 固件版本路由
		deviceRouter.InitModelFirmwareRelRouter(PrivateGroup)                // 型号固件关系路由
		deviceRouter.InitFirmwareTagRouter(PrivateGroup)                     // 固件标签路由
		deviceRouter.InitFirmwareVersionLogRouter(PrivateGroup, PublicGroup) // 固件日志路由
