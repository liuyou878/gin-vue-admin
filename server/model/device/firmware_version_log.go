...
type FirmwareVersionLog struct {
	...
	Action     string          `json:"action" form:"action" gorm:"column:action;comment:动作:upload/bind_model/start_testing/test_pass/test_fail/set_recommended/set_stable/unset_stable/deprecate;size:32;not null"` // 动作
