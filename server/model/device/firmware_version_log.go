...
type FirmwareVersionLog struct {
	...
	PackageURL    string          `json:"packageUrl" form:"packageUrl" gorm:"column:package_url;comment:安装包地址快照;size:500"`                                                                                                                                                                  // 安装包地址快照
	PackageName   string          `json:"packageName" form:"packageName" gorm:"column:package_name;comment:安装包名称快照;size:255"`                                                                                                                                                               // 安装包名称快照
	PackageFileID uint            `json:"packageFileId" form:"packageFileId" gorm:"column:package_file_id;comment:安装包文件ID快照;default:0"`                                                                                                                                                     // 安装包文件ID快照
	PackageSize   int64           `json:"packageSize" form:"packageSize" gorm:"column:package_size;comment:安装包大小快照;default:0"`                                                                                                                                                              // 安装包大小快照
	Checksum      string          `json:"checksum" form:"checksum" gorm:"column:checksum;comment:校验值快照;size:128"`                                                                                                                                                                           // 校验值快照
